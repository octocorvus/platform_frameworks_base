...
public final class RemoteSelectionToolbar {
    ...
    private static List<ToolbarMenuItem> transformMenuItems(Context context,
        ...
        for (int i = 0; i < menuItems.size(); i++) {
            ...
            String currentTitle = menuItem.title == null ? null : menuItem.title.toString();
            if (TextUtils.equals(currentTitle, pasteString)) {
                resolvedItemId = android.R.id.paste;
            } else if (TextUtils.equals(currentTitle, pasteAsPlainTextString)) {
